...
class mineTitleContent extends StatefulWidget {
  // const activityList({ Key? key }) : super(key: key);

  @override
  _mineTitleContentState createState() => _mineTitleContentState();
}

class _mineTitleContentState extends State<mineTitleContent> {
  @override
  void initState() {
    //初始化函数、带监听滑动功能
    super.initState();
  ...
  getAllTitle() async {
    var url = Uri.parse(Api.url + '/cs1902/title/' + uid + '/1/all');
    var response =
                            ...
                            child: Container(
                                decoration: new BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                        image: AssetImage(
                                            "lib/assets/titleImages/bronze.jpg"),
                                        fit: BoxFit.cover)),
